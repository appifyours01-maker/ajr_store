...
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/ajr_store__app', {
...
app.get('/api/app-config', async (req, res) => {
  ...
  try {
    ...
    const config = {
      ...
      adminId: '6a70c163e69a1f181c7875c9',
...
app.listen(PORT, () => {
  ...
  console.log(`Ajr store  Backend Server running on port ${PORT}`);
